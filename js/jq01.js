...
// li:eq(3)
// li:lt(3) less than
// li:gt(3) greater than
// li:not(:first) first가 아닌 거
// li:nth-child(2n)
// li:nth-of-type(2n)
// li:contains (문자열) 특정문자열을 포함하는거
...
// $('li').closest('div') li 태그에서 가장 가까운 div 태그 선택
// $('a,span') 복합선택자 a태그,span태그 선택
// $('a','li') li 태그에서 그 하위태그 a를 선택해라
// $('li').find('a') li 태그에서 그 하위태그 a를 선택해라 /위에랑 같음
// $('li a')
