...
console.log("A".codePointAt()); //65 ASCI 아스키코드
...
// 없으면 false 를 반환하고 그다음 요소를 찾는다.

var fruit = ["apple", "strawberry", "banana", "cherry"];
// fruit에서 글자가 5개이상인 과일명만 추출하시오.
